...
urlpatterns = [
    ...
    #path('confirm_attendance/<int:course_id>/', views.confirm_attendance, name='confirm_attendance'),
    path('student/attendance/', views.student_attendance, name='student_attendance'),
    path('lecturer/confirm-attendance/', views.lecturer_confirm_attendance, name='lecturer_confirm_attendance'),
    path('confirm-attendance/', views.ConfirmAttendanceView.as_view(), name='confirm_attendance'),
